; BONEBOX-01 core kernel
; 16-bit real mode. No DOS calls after boot handoff.
...
banner db 'BONEBOX-01 v0.1.4', 10
       db 'direct screen. key memory. clock sense.', 10
...
ver_msg db 'BONEBOX-01 v0.1.4 last cut', 10, 0
